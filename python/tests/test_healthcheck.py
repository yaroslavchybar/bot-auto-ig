...
from python.core.process.healthcheck import check_internet, check_disk_space, check_proxy, run_all_checks
...
def test_run_all_checks():
    with patch("python.core.process.healthcheck.check_internet", return_value=True), \
         patch("python.core.process.healthcheck.check_disk_space", return_value=True), \
         patch("python.core.process.healthcheck.check_proxy", return_value=True):
