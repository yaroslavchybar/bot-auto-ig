...
export const clerkAppearance = {
  ...
  elements: {
    ...
    cardBox:
      'bg-panel border border-line shadow-none rounded-2xl max-h-[700px] h-[75vh]', // Dark modal wrapper with custom height
    ...
    socialButtonsBlockButton:
      'bg-transparent border border-line text-copy hover:bg-panel-hover hover:text-white rounded-lg text-[11px] h-7 transition-all',
    ...
    identityPreviewEditButton:
      'text-muted-copy hover:text-white transition-colors',
    ...
    profileSectionPrimaryButton:
      'text-copy hover:text-white transition-colors text-[11px] font-medium',
    profilePage: 'bg-panel',
    badge:
      'bg-panel-muted border-line text-copy text-[9px] uppercase tracking-wider rounded-lg',
    navbar: 'bg-panel border-r border-line', // Sidebar of the profile modal
    navbarButton:
    ...
    avatarImageActionsUpload:
      'text-copy hover:text-white transition-colors text-[11px]',
