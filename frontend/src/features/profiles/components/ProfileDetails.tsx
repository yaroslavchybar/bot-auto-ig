...
function ProfileHeaderSection({ profile }: { profile: Profile }) {
  return (
...
function ProfileStatusSection({ profile }: { profile: Profile }) {
  return (
...
function ProfileNetworkSection({ profile }: { profile: Profile }) {
  return (
    <div className="p-6">
...
export function ProfileDetails({ profile }: ProfileDetailsProps) {
  return (
    <div className="flex flex-col">
      ...
      <ProfileNetworkSection profile={profile} />
      <Separator className="bg-panel-muted" />
      <ProfileFingerprintSection profile={profile} />
      <Separator className="bg-panel-muted" />
