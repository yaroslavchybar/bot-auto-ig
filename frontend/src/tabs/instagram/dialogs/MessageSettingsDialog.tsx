...
export function MessageSettingsDialog({ open, onOpenChange }: MessageSettingsDialogProps) {
    const [kind, setKind] = useState<'message' | 'message_2'>('message');
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl h-[600px] flex flex-col">
                ...
                <Tabs value={kind} onValueChange={(v) => setKind(v as 'message' | 'message_2')} className="flex-1 flex flex-col min-h-0">
