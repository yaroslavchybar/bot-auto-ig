...
| `docs/server/guide.md` | server | API | partial | Needed current startup behavior, CORS/auth detail, and workflow-orchestration surface updates | Refreshed startup, route, and verification sections | accurate |
